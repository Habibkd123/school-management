                  ...
                  <div className="absolute right-0 sm:left-0 sm:right-auto top-full mt-2 w-64 bg-white dark:bg-slate-900 border border-border rounded-lg shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] z-50 text-left">
                    ...
                    <div className="p-4 space-y-4">
                      <div className="space-y-1.5">
                        <label className="text-[13px] font-bold text-slate-800 dark:text-slate-100">Grade</label>
                        <div className="relative">
            ...
            <tbody className="divide-y divide-border">
              {filteredData.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{item.grade}</td>
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{item.percentage}</td>
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{item.gradePoints}</td>
                  <td className="px-6 py-4">
