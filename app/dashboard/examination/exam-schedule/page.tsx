    ...
    <div className="space-y-6 bg-[#F8FAFC] min-h-screen -m-6 p-6">
      ...
      <div className="bg-white border border-border rounded-xl shadow-sm overflow-hidden text-left">
        ...
        <div className="p-5 border-b border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <h2 className="text-[16px] font-bold text-slate-800">Exam Schedule</h2>
                  ...
                  <div className="absolute right-0 sm:left-0 sm:right-auto top-full mt-2 w-64 bg-white border border-border rounded-lg shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] z-50 text-left">
                    ...
                    <div className="p-4 space-y-4">
                      <div className="space-y-1.5">
                        <label className="text-[13px] font-bold text-slate-800">Class 1-A</label>
                        <div className="relative">
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[13px] font-bold text-slate-800">Exam Date</label>
                        <div className="relative">
                          <select className="w-full px-3 py-2 border border-border rounded-lg text-[13px] outline-none appearance-none bg-white text-slate-600 font-medium cursor-pointer">
                            <option>Select</option>
          ...
          <table className="w-full text-[13px]">
            <thead className="bg-[#F8FAFC] border-y border-border">
              <tr>
                ...
                <th className="px-6 py-4 text-left font-bold text-slate-700">Exam Date</th>
                ...
                <th className="px-6 py-4 text-left font-bold text-slate-700">Duration</th>
                <th className="px-6 py-4 text-left font-bold text-slate-700">Room No</th>
                <th className="px-6 py-4 text-left font-bold text-slate-700">Max Marks</th>
                <th className="px-6 py-4 text-left font-bold text-slate-700">Min Marks</th>
            ...
            <tbody className="divide-y divide-border">
              {filteredData.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="px-6 py-4 text-slate-600">{item.examDate}</td>
                  <td className="px-6 py-4 text-slate-600">{item.startTime}</td>
                  <td className="px-6 py-4 text-slate-600">{item.endTime}</td>
                  <td className="px-6 py-4 text-slate-600">{item.duration}</td>
                  <td className="px-6 py-4 text-slate-600">{item.roomNo}</td>
                  <td className="px-6 py-4 text-slate-600">{item.maxMarks}</td>
                  <td className="px-6 py-4 text-slate-600">{item.minMarks}</td>
        ...
        <form onSubmit={isAddOpen ? handleAddSubmit : handleEditSubmit} className="p-6 text-left flex flex-col h-[80vh]">
          <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 pb-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="space-y-1.5">
                <label className="text-[13px] font-bold text-slate-800">Exam Name</label>
                <div className="relative">
                  <select 
                    value={formExamName}
            ...
            <div className="space-y-4 pt-4 border-t border-border">
              {scheduleRows.map((row, index) => (
                <div key={row.id} className="flex flex-wrap items-end gap-3">
                  <div className="flex-1 min-w-[140px] space-y-1.5">
                    {index === 0 && <label className="text-[13px] font-bold text-slate-800">Exam Date</label>}
                    <div className="relative">
                      <select 
                        value={row.examDate}
                        onChange={(e) => updateScheduleRow(row.id, "examDate", e.target.value)}
                        className="w-full px-3 py-2 text-[14px] bg-white border border-border rounded-lg outline-none focus:border-[#5D6BEE] transition-colors appearance-none text-slate-700 cursor-pointer"
                        required
                      >
                        <option value="">Select</option>
                  ...
                  <div className="flex-1 min-w-[140px] space-y-1.5">
                    {index === 0 && <label className="text-[13px] font-bold text-slate-800">Subject</label>}
                    <div className="relative">
                      <select 
                        value={row.subject}
                  ...
                  <div className="flex-1 min-w-[120px] space-y-1.5">
                    {index === 0 && <label className="text-[13px] font-bold text-slate-800">Room No</label>}
                    <div className="relative">
                      <select 
                        value={row.roomNo}
                  ...
                  <div className="flex-1 min-w-[120px] space-y-1.5">
                    {index === 0 && <label className="text-[13px] font-bold text-slate-800">Max Marks</label>}
                    <div className="relative">
                      <select 
                        value={row.maxMarks}
                  ...
                  <div className="flex-1 min-w-[120px] space-y-1.5">
                    {index === 0 && <label className="text-[13px] font-bold text-slate-800">Min Marks</label>}
                    <div className="relative">
                      <select 
                        value={row.minMarks}
                  ...
                  <button 
                    ...
                    className={`w-10 h-10 flex items-center justify-center rounded-lg border flex-shrink-0 transition-colors ${scheduleRows.length === 1 ? "bg-slate-50 border-border text-slate-300 cursor-not-allowed" : "bg-rose-50 border-rose-100 text-rose-500 hover:bg-rose-100 cursor-pointer"}`}
                  >
              ...
              <div className="pt-2">
                <button 
                  ...
                  className="px-4 py-2 bg-[#5D6BEE] hover:bg-[#4b58ce] text-white text-[13px] font-bold rounded-lg flex items-center gap-2 transition-colors cursor-pointer"
                >
