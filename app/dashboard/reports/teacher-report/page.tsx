...
const mockTeacherReport: TeacherReportItem[] = [
  { id: "1", name: "Aaron", avatar: "https://ui-avatars.com/api/?name=Aaron&background=F1F5F9&color=5D6BEE&bold=true", percent: 95, p: 21, l: 2, a: 1, h: 6, f: 2, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "2", name: "Daniel", avatar: "https://ui-avatars.com/api/?name=Daniel&background=F1F5F9&color=5D6BEE&bold=true", percent: 95, p: 23, l: 1, a: 2, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "3", name: "Edward", avatar: "https://ui-avatars.com/api/?name=Edward&background=F1F5F9&color=5D6BEE&bold=true", percent: 97, p: 15, l: 1, a: 1, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "4", name: "Elizabeth", avatar: "https://ui-avatars.com/api/?name=Elizabeth&background=F1F5F9&color=5D6BEE&bold=true", percent: 32, p: 20, l: 3, a: 1, h: 6, f: 4, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "5", name: "Erickson", avatar: "https://ui-avatars.com/api/?name=Erickson&background=F1F5F9&color=5D6BEE&bold=true", percent: 45, p: 16, l: 2, a: 1, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "6", name: "Hellana", avatar: "https://ui-avatars.com/api/?name=Hellana&background=F1F5F9&color=5D6BEE&bold=true", percent: 94, p: 23, l: 1, a: 3, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "7", name: "Jacquelin", avatar: "https://ui-avatars.com/api/?name=Jacquelin&background=F1F5F9&color=5D6BEE&bold=true", percent: 99, p: 22, l: 0, a: 4, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "8", name: "Janet", avatar: "https://ui-avatars.com/api/?name=Janet&background=F1F5F9&color=5D6BEE&bold=true", percent: 97, p: 22, l: 1, a: 1, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "9", name: "Morgan", avatar: "https://ui-avatars.com/api/?name=Morgan&background=F1F5F9&color=5D6BEE&bold=true", percent: 100, p: 16, l: 2, a: 1, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
  { id: "10", name: "Raul", avatar: "https://ui-avatars.com/api/?name=Raul&background=F1F5F9&color=5D6BEE&bold=true", percent: 98, p: 23, l: 0, a: 2, h: 6, f: 1, days: ["P", "A", "P", "A", "P", "L", "L", "P", "P", "P", "P", "L", "L", "L", "P", "P", "L"] },
];
  ...
  return (
    <div className="space-y-6 bg-[#F8FAFC] dark:bg-[#0F172A] min-h-screen -m-6 p-6 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900 dark:text-white">Teacher's Report</h1>
          <div className="flex items-center gap-2 text-[13px] text-slate-500 dark:text-slate-400 mt-1">
            <span>Dashboard</span>
            <span>/</span>
            <span className="hover:text-[#F59E0B] cursor-pointer">Report</span>
            <span>/</span>
            <span className="text-slate-900 dark:text-white font-medium">Teacher's Report</span>
          </div>
        </div>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-[320px] bg-white dark:bg-slate-900 border border-border rounded-lg shadow-[0_10px_40px_-10px_rgba(0,0,0,0.15)] z-50 flex flex-col text-left">
                    ...
                    <div className="p-4 grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[13px] font-bold text-[#0F172A] dark:text-slate-200">Month</label>
                        <div className="relative">
                          <select className="w-full px-3 py-2 bg-white dark:bg-slate-800 border border-border rounded-md text-[13px] appearance-none outline-none text-slate-600 dark:text-slate-300">
                            <option>Select</option>
                          </select>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[13px] font-bold text-[#0F172A] dark:text-slate-200">Date</label>
                        <div className="relative">
                          <select className="w-full px-3 py-2 bg-white dark:bg-slate-800 border border-border rounded-md text-[13px] appearance-none outline-none text-slate-600 dark:text-slate-300">
                            <option>Date</option>
                          </select>
          ...
          <table className="w-full text-[13px] whitespace-nowrap min-w-[1200px]">
            <thead className="bg-[#F8FAFC] dark:bg-[#0F172A]">
              <tr className="border-y border-border">
                <th className="px-6 py-4 text-left font-bold text-slate-700 dark:text-slate-200 sticky left-0 bg-[#F8FAFC] dark:bg-[#0F172A] z-10 border-r border-border/50 shadow-[4px_0_10px_-5px_rgba(0,0,0,0.1)]">Teacher / Date</th>
