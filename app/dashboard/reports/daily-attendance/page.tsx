...
const mockData: DailyAttendanceItem[] = [
  { id: "1", className: "I", section: "C", totalPresent: 54, totalAbsent: 7, presentPercent: "98%", absentPercent: "1%" },
  { id: "2", className: "II", section: "B", totalPresent: 69, totalAbsent: 8, presentPercent: "89%", absentPercent: "11%" },
  { id: "3", className: "II", section: "A", totalPresent: 65, totalAbsent: 1, presentPercent: "98%", absentPercent: "2%" },
  { id: "4", className: "III", section: "A", totalPresent: 69, totalAbsent: 2, presentPercent: "98%", absentPercent: "2%" },
  { id: "5", className: "III", section: "B", totalPresent: 78, totalAbsent: 2, presentPercent: "72%", absentPercent: "28%" },
  { id: "6", className: "IV", section: "A", totalPresent: 45, totalAbsent: 7, presentPercent: "78%", absentPercent: "22%" },
  { id: "7", className: "IX", section: "A", totalPresent: 45, totalAbsent: 1, presentPercent: "98%", absentPercent: "2%" },
  { id: "8", className: "V", section: "C", totalPresent: 65, totalAbsent: 0, presentPercent: "100%", absentPercent: "0%" },
  { id: "9", className: "VI", section: "A", totalPresent: 45, totalAbsent: 2, presentPercent: "98%", absentPercent: "1%" },
  { id: "10", className: "VII", section: "C", totalPresent: 45, totalAbsent: 7, presentPercent: "89%", absentPercent: "11%" },
];
  ...
  return (
    <div className="space-y-6 bg-[#F8FAFC] dark:bg-[#0F172A] min-h-screen -m-6 p-6 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900 dark:text-white">Daily Attendance</h1>
          ...
          <table className="w-full text-[13px] whitespace-nowrap">
            <thead className="bg-[#F8FAFC] dark:bg-[#0F172A]">
              <tr className="border-y border-border">
                ...
                <th className="px-6 py-4 text-left font-bold text-slate-700 dark:text-slate-200">Total Present</th>
                <th className="px-6 py-4 text-left font-bold text-slate-700 dark:text-slate-200">Total Absent</th>
            ...
            <tbody className="divide-y divide-border">
              {filteredData.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{item.totalPresent}</td>
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{item.totalAbsent}</td>
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{item.presentPercent}</td>
                  <td className="px-6 py-4 text-slate-600 dark:text-slate-300">{item.absentPercent}</td>
                </tr>
              ))}
            </tbody>
          </table>
