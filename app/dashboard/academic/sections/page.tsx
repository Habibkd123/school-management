    ...
    <div className="space-y-6 bg-[#F8FAFC] min-h-screen -m-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-2 text-[13px] text-slate-500 mt-1">
            ...
            <span>/</span>
            <span className="text-slate-900 font-medium">Sections</span>
          </div>
        </div>
      ...
      <div className="bg-white border border-border rounded-xl shadow-sm overflow-hidden text-left">
        ...
        <div className="p-5 border-b border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <h2 className="text-[16px] font-bold text-slate-800">Class Section</h2>
          ...
          <table className="w-full text-[13px]">
            <thead className="bg-[#F8FAFC] border-y border-border">
              <tr>
                ...
                <th className="px-6 py-4 text-left font-bold text-slate-700">Section Name</th>
            ...
            <tbody className="divide-y divide-border">
              {filteredSections.map((section) => (
                <tr key={section.id} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="px-6 py-4 font-semibold text-[#5D6BEE]">{section.id}</td>
                  <td className="px-6 py-4 text-slate-600">{section.name}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-center relative" onClick={(e) => e.stopPropagation()}>
                    <button 
                      ...
                      className={`p-1.5 rounded-lg transition-colors cursor-pointer ${actionMenuId === section.id ? "bg-[#5D6BEE] text-white" : "hover:bg-slate-100 text-slate-400"}`}
                    >
                    ...
                    {actionMenuId === section.id && (
                      <>
                        ...
                        <div className="absolute right-10 top-10 w-36 bg-white border border-border rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] z-50 overflow-hidden py-2 text-left">
                          <button onClick={() => openEditModal(section)} className="w-full px-4 py-2 text-[13px] text-[#202c4b] hover:bg-slate-50 flex items-center gap-2 font-medium transition-colors cursor-pointer">
                            <Edit className="w-4 h-4 text-[#202c4b]" /> Edit
                          </button>
                          <button onClick={() => openDeleteModal(section)} className="w-full px-4 py-2 text-[13px] text-[#202c4b] hover:bg-slate-50 flex items-center gap-2 font-medium transition-colors cursor-pointer">
