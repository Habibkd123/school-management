    ...
    <div className="space-y-6 bg-[#F8FAFC] dark:bg-[#0F172A] min-h-screen -m-6 p-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-border rounded-xl shadow-sm overflow-hidden text-left p-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
          <h2 className="text-[16px] font-bold text-slate-800 dark:text-slate-100">Time Table</h2>
          
          <div className="flex items-center gap-3">
            <div className="relative">
              <button 
                onClick={() => setIsFilterOpen(!isFilterOpen)}
                className="px-4 py-2 bg-white dark:bg-slate-900 border border-border text-slate-700 dark:text-slate-200 text-[13px] font-medium rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors flex items-center gap-2 shadow-sm cursor-pointer"
              >
        ...
        <div className="overflow-x-auto pb-4">
          <div className="min-w-[1000px]">
            ...
            <div className="grid grid-cols-6 gap-4 mt-8">
              <div className="col-span-2 bg-[#F8FAFC] dark:bg-[#0F172A] border border-border rounded-xl p-4 flex flex-col justify-center">
                <span className="inline-block bg-[#F59E0B] text-white text-[11px] font-bold px-2.5 py-1 rounded w-max mb-2">Morning Break</span>
                <div className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400 text-[12px] font-medium">
      ...
      {isAddOpen && (
        <>
          ...
          <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[900px] bg-white dark:bg-slate-900 rounded-2xl shadow-xl z-[70] overflow-hidden text-left flex flex-col max-h-[90vh]">
            
            <div className="flex items-center justify-between p-6 border-b border-border bg-white dark:bg-slate-900">
              <h2 className="text-xl font-bold text-[#0F172A] dark:text-slate-100">Add Time Table</h2>
              <button 
                onClick={() => setIsAddOpen(false)}
                className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 text-slate-500 dark:text-slate-400 transition-colors cursor-pointer"
              >
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="space-y-1.5">
                  <label className="text-[13px] font-bold text-slate-800 dark:text-slate-100">Class</label>
                  <input type="text" className="w-full px-4 py-2.5 text-[14px] bg-white dark:bg-slate-900 border border-border rounded-lg outline-none focus:border-[#F59E0B] transition-colors text-slate-700 dark:text-slate-200" />
                </div>
                
                <div className="space-y-1.5">
                  <label className="text-[13px] font-bold text-slate-800 dark:text-slate-100">Section</label>
                  <div className="relative">
                    <select className="w-full px-4 py-2.5 text-[14px] bg-white dark:bg-slate-900 border border-border rounded-lg outline-none focus:border-[#F59E0B] transition-colors appearance-none text-slate-700 dark:text-slate-200 cursor-pointer">
                      <option>A</option>
                      <option>B</option>
                      <option>C</option>
                    </select>
                ...
                <div className="space-y-1.5">
                  <label className="text-[13px] font-bold text-slate-800 dark:text-slate-100">Period Start Time</label>
                  <div className="relative">
                    <select className="w-full px-4 py-2.5 text-[14px] bg-white dark:bg-slate-900 border border-border rounded-lg outline-none focus:border-[#F59E0B] transition-colors appearance-none text-slate-700 dark:text-slate-200 cursor-pointer">
                      <option>Select</option>
              ...
              {/* Tabs */}
              <div className="bg-[#F8FAFC] dark:bg-[#0F172A] border border-border rounded-xl p-4">
                <div className="flex border-b border-border mb-6 overflow-x-auto custom-scrollbar">
                  {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"].map(day => (
                    <button 
                      key={day}
                      onClick={() => setActiveTab(day)}
                      className={`px-6 py-3 text-[14px] font-bold border-b-2 transition-colors whitespace-nowrap ${activeTab === day ? "border-[#F59E0B] text-[#F59E0B]" : "border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-200"}`}
                    >
                      {day}
                    </button>
                  ))}
                ...
                <div className="space-y-4">
                  {dynamicRows.map((row) => (
                    <div key={row.id} className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[13px] font-bold text-slate-800 dark:text-slate-100">Time From</label>
                        <div className="relative">
                          <select className="w-full px-4 py-2.5 text-[14px] bg-white dark:bg-slate-900 border border-border rounded-lg outline-none focus:border-[#F59E0B] transition-colors appearance-none text-slate-700 dark:text-slate-200 cursor-pointer">
                            <option>Select</option>
                            <option>09:00 AM</option>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[13px] font-bold text-slate-800 dark:text-slate-100">Time To</label>
                        <div className="relative">
                          <select className="w-full px-4 py-2.5 text-[14px] bg-white dark:bg-slate-900 border border-border rounded-lg outline-none focus:border-[#F59E0B] transition-colors appearance-none text-slate-700 dark:text-slate-200 cursor-pointer">
                            <option>Select</option>
                      ...
                      <div className="pb-1">
                        <button 
                          ...
                          className="w-10 h-10 flex items-center justify-center rounded-lg bg-rose-50 dark:bg-rose-500/10 text-rose-500 hover:bg-rose-100 dark:hover:bg-rose-500/20 transition-colors"
                        >
                  ...
                  <button 
                    onClick={addRow}
                    className="px-4 py-2 bg-[#F59E0B] hover:bg-[#D97706] text-white text-[13px] font-bold rounded-lg flex items-center gap-2 transition-colors mt-4 shadow-sm cursor-pointer"
                  >
            ...
            <div className="p-6 border-t border-border bg-white dark:bg-slate-900 flex items-center justify-end gap-3">
              <button 
                onClick={() => setIsAddOpen(false)}
