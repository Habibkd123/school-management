...
export default function StudentViewPage() {
  ...
  // Tab states
  const [activeMainTab, setActiveMainTab] = useState<string>("Student Details");
  ...
  return (
    <div className="space-y-6 bg-[#F8FAFC] min-h-screen -m-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-left">
        <div>
          <h1 className="text-[20px] leading-[24px] font-semibold text-[#202c4b]">Student Details</h1>
          <div className="flex items-center gap-2 text-[14px] leading-[21px] text-[#68718a] mt-1 font-normal">
            <span>Dashboard</span>
            <span>/</span>
            <Link href="/dashboard/students" className="hover:text-[#5D6BEE]">Student</Link>
            <span>/</span>
            <span className="text-[#202c4b] font-normal">Student Details</span>
          </div>
        </div>

        <div className="flex items-center gap-3">
          <button onClick={() => setIsLoginModalOpen(true)} className="flex items-center gap-2 px-3 py-1.5 border border-border rounded-lg bg-white text-[12px] font-bold text-slate-700 hover:bg-slate-50 shadow-sm transition-colors">
            <Lock className="w-3.5 h-3.5" />
            <span>Login Details</span>
          </button>
          <button
            onClick={() => router.push(`/dashboard/students/add?edit=${student.id}`)}
            className="flex items-center gap-2 px-3 py-1.5 bg-[#5D6BEE] hover:bg-[#4b58ce] text-white text-[12px] font-bold rounded-lg shadow-sm transition-colors"
          >
      ...
      <div className="flex flex-col xl:flex-row gap-6 items-start">
        ...
        <div className="w-full xl:w-[300px] flex-shrink-0 space-y-6">
          ...
          {/* Profile Card */}
          <div className="bg-white border border-border rounded-xl p-4 card-shadow text-left relative overflow-hidden">
            <div className="flex items-center gap-4">
              <img src={getAvatar(student.name)} className="w-[60px] h-[60px] rounded-xl object-cover border border-slate-200" alt="Avatar" />
              <div>
                ...
                <h2 className="text-[16px] leading-[19.2px] font-medium text-[#202c4b]">{student.name}</h2>
                <p className="text-[12px] text-[#5D6BEE] font-bold mt-0.5">AD1 256589</p>
              </div>
            </div>
          </div>

          {/* Basic Information */}
          <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow text-left">
            <div className="px-4 py-3 border-b border-border bg-slate-50/50">
              <h3 className="text-[16px] leading-[19.2px] font-medium text-[#202c4b]">Basic Information</h3>
            </div>
            <div className="p-4 text-[12px]">
              <div className="space-y-3.5">
                ...
                <div className="flex justify-between py-1">
                  <span className="text-[14px] leading-[21px] font-medium text-[#202c4b]">Language</span>
                  <div className="flex gap-1.5">
                    <span className="px-1.5 py-0.5 bg-slate-100 rounded text-[10px] font-bold text-slate-700">English</span>
                    <span className="px-1.5 py-0.5 bg-slate-100 rounded text-[10px] font-bold text-slate-700">Spanish</span>
                  </div>
                </div>
              </div>
              <button onClick={() => setIsFeesModalOpen(true)} className="w-full mt-5 py-2 bg-[#5D6BEE] hover:bg-[#4b58ce] text-white text-[12px] font-bold rounded-lg shadow-sm transition-colors">
                Add Fees
              </button>
            </div>
          </div>
          ...
          <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow text-left">
            <div className="px-4 py-3 border-b border-border bg-slate-50/50">
              <h3 className="text-[13px] font-bold text-slate-900">Primary Contact Info</h3>
            </div>
            <div className="p-4 space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[11px] font-bold text-slate-900 mb-0.5">Phone Number</p>
                  <p className="text-[12px] text-slate-500 font-medium">+1 46548 84498</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center border border-slate-100 flex-shrink-0">
                ...
                <div>
                  <p className="text-[11px] font-bold text-slate-900 mb-0.5">Email Address</p>
                  <p className="text-[12px] text-slate-500 font-medium">{student.email}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow text-left">
            <div className="px-4 py-3 border-b border-border bg-slate-50/50">
              <h3 className="text-[13px] font-bold text-slate-900">Sibling Information</h3>
            </div>
            <div className="p-4 space-y-3.5">
              <div className="flex items-center gap-3">
                <img src={getAvatar("Ralph Claudia")} className="w-9 h-9 rounded object-cover" />
                <div>
                  <p className="text-[12px] font-bold text-slate-900">Ralph Claudia</p>
                  <p className="text-[11px] text-slate-500 font-medium">III, B</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[12px] font-bold text-slate-900">Julie Scott</p>
                  <p className="text-[11px] text-slate-500 font-medium">V, A</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow text-left">
            <div className="flex border-b border-border">
              <button
                ...
                className={`flex-1 py-2.5 text-[12px] font-bold transition-colors ${bottomTab === "Hostel" ? "text-[#5D6BEE] border-b-2 border-[#5D6BEE]" : "text-slate-500"}`}
              >
                Hostel
              </button>
              <button
                onClick={() => setBottomTab("Transportation")}
                className={`flex-1 py-2.5 text-[12px] font-bold transition-colors ${bottomTab === "Transportation" ? "text-[#5D6BEE] border-b-2 border-[#5D6BEE]" : "text-slate-500"}`}
              >
                Transportation
              </button>
            </div>
            <div className="p-4">
              {bottomTab === "Hostel" ? (
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#5D6BEE]/10 flex items-center justify-center flex-shrink-0">
                    <Building2 className="w-3.5 h-3.5 text-[#5D6BEE]" />
                  </div>
                  <div>
                    <p className="text-[12px] font-bold text-slate-900">HI-Hostel, Floor</p>
                    <p className="text-[11px] text-[#5D6BEE] font-bold">Room No : 25</p>
                  </div>
                </div>
              ) : (
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#5D6BEE]/10 flex items-center justify-center flex-shrink-0">
                    <Bus className="w-3.5 h-3.5 text-[#5D6BEE]" />
                  </div>
                  <div>
                    <p className="text-[12px] font-bold text-slate-900">Bus Route 42</p>
                    <p className="text-[11px] text-[#5D6BEE] font-bold">Pickup : 07:30 AM</p>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-5">
          ...
          {/* Top Tabs Header */}
          <div className="bg-white border-b border-border rounded-t-xl overflow-x-auto custom-scrollbar flex items-center gap-1 px-1.5 pt-1.5">
            ...
            <div className="space-y-5 text-left animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                <div className="p-4 border-b border-border bg-slate-50/30">
                  <h3 className="text-[14px] font-bold text-slate-900">Parents Information</h3>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                  <div className="p-4 border-b border-border bg-slate-50/30">
                    <h3 className="text-[14px] font-bold text-slate-900">Address</h3>
                  </div>
                  <div className="p-5 space-y-5">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-[12px] font-bold text-slate-900 mb-0.5">Current Address</p>
                        <p className="text-[11px] text-slate-500 font-medium">3495 Red Hawk Road, Buffalo Lake, MN 55314</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-7 h-7 rounded-full bg-slate-50 flex items-center justify-center flex-shrink-0 border border-slate-100">
                      ...
                      <div>
                        <p className="text-[12px] font-bold text-slate-900 mb-0.5">Permanent Address</p>
                        <p className="text-[11px] text-slate-500 font-medium">3495 Red Hawk Road, Buffalo Lake, MN 55314</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                <div className="p-4 border-b border-border bg-slate-50/30">
                  <h3 className="text-[14px] font-bold text-slate-900">Previous School Details</h3>
                </div>
                <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <p className="text-[11px] font-bold text-slate-900 mb-1">Previous School Name</p>
                    <p className="text-[12px] text-slate-500 font-medium">Oxford Matriculation, USA</p>
                  </div>
                  <div>
                    <p className="text-[11px] font-bold text-slate-900 mb-1">School Address</p>
                    <p className="text-[12px] text-slate-500 font-medium">1852 Barnes Avenue, Cincinnati, OH 45202</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden h-full">
                  <div className="p-4 border-b border-border bg-slate-50/30">
                    <h3 className="text-[14px] font-bold text-slate-900">Bank Details</h3>
                  </div>
                  <div className="p-5 grid grid-cols-3 gap-4">
                    <div>
                      <p className="text-[11px] font-bold text-slate-900 mb-1">Bank Name</p>
                      <p className="text-[12px] text-slate-500 font-medium">Bank of America</p>
                    </div>
                    <div>
                      <p className="text-[11px] font-bold text-slate-900 mb-1">Branch</p>
                      <p className="text-[12px] text-slate-500 font-medium">Cincinnati</p>
                    </div>
                    <div>
                      <p className="text-[11px] font-bold text-slate-900 mb-1">IFSC</p>
                      <p className="text-[12px] text-slate-500 font-medium">BOA83209832</p>
                    </div>
                  </div>
                </div>
                <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden h-full">
                  <div className="p-4 border-b border-border bg-slate-50/30">
                    <h3 className="text-[14px] font-bold text-slate-900">Medical History</h3>
                  </div>
                  <div className="p-5 grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-[11px] font-bold text-slate-900 mb-2">Known Allergies</p>
                      <span className="px-2 py-0.5 bg-slate-100 text-slate-700 text-[10px] font-bold rounded border border-slate-200">Rashes</span>
                    </div>
                    <div>
                      <p className="text-[11px] font-bold text-slate-900 mb-1">Medications</p>
                      <p className="text-[12px] text-slate-500 font-medium">-</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                <div className="p-4 border-b border-border bg-slate-50/30">
                  <h3 className="text-[14px] font-bold text-slate-900">Other Info</h3>
                </div>
                <div className="p-5">
            ...
            <div className="space-y-5 text-left animate-in fade-in zoom-in-95 duration-200">
              <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                <div className="p-4 border-b border-border flex items-center justify-between">
                  <h3 className="text-[14px] font-bold text-slate-900">Fees</h3>
                  <div className="px-3 py-1.5 border border-border rounded-lg flex items-center gap-2 cursor-pointer hover:bg-slate-50 text-[11px] font-bold text-slate-700">
                ...
                <div className="p-4 border-b border-border flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-50/30">
                  <div className="flex items-center gap-2 text-[12px] text-slate-600 font-medium">
                    ...
                    <select className="border border-border rounded px-2 py-1 outline-none bg-white font-bold text-slate-700"><option>10</option></select>
                    <span>Entries</span>
                  </div>
                  <input type="text" placeholder="Search" className="px-3 py-1.5 border border-border rounded-lg text-[12px] outline-none w-full sm:w-64 focus:border-[#5D6BEE]/50 transition-colors" />
                </div>

                <div className="overflow-x-auto custom-scrollbar">
                  <table className="w-full text-left text-[12px] min-w-[900px]">
                    <thead className="bg-[#F8FAFC] text-slate-700 border-b border-border font-bold">
                      <tr>
          ...
          {activeMainTab === "Exam & Results" && (
            <div className="space-y-5 text-left animate-in fade-in zoom-in-95 duration-200">
              <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                <div className="p-4 border-b border-border flex items-center justify-between">
                  <h3 className="text-[14px] font-bold text-slate-900">Exams & Results</h3>
                  <div className="px-3 py-1.5 border border-border rounded-lg flex items-center gap-2 cursor-pointer hover:bg-slate-50 text-[11px] font-bold text-slate-700">
                    <Calendar className="w-3.5 h-3.5 text-slate-400" />
                    <span>Year : 2024 / 2025</span>
                    <ChevronDown className="w-3.5 h-3.5" />
          ...
          {activeMainTab === "Time Table" && (
            <div className="bg-white border border-border rounded-xl card-shadow p-5 text-left animate-in fade-in zoom-in-95 duration-200">
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-[14px] font-bold text-slate-900">Exams & Results</h2>
                <div className="px-3 py-1.5 border border-border rounded-lg text-[11px] font-bold text-slate-700 flex items-center gap-2 cursor-pointer hover:bg-slate-50">
                  <Calendar className="w-3.5 h-3.5 text-slate-400" />
                  <span>This Year</span>
                ...
                <div className="min-w-[900px]">
                  <div className="grid grid-cols-6 gap-3 mb-3">
                    {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].map(day => (
                      <div key={day} className="text-[13px] font-bold text-slate-900 pb-2 border-b border-slate-100">{day}</div>
                    ))}
                  </div>
                        ...
                        {col.map((slot, sIdx) => (
                          <div key={sIdx} className={`p-3 rounded-lg border ${slot.bg} ${slot.border} transition-transform hover:-translate-y-1 cursor-pointer`}>
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-[11px] font-bold text-slate-700">{slot.teacher}</span>
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  <div className="flex items-center gap-5 mt-6 pt-5 border-t border-slate-100">
                    <div className="flex-1 p-3 rounded-xl border border-slate-100 flex flex-col gap-1.5">
                      <span className="px-2.5 py-0.5 bg-[#5D6BEE] text-white text-[10px] font-bold rounded self-start">Morning Break</span>
          ...
          {activeMainTab === "Leave & Attendance" && (
            <div className="space-y-5 text-left animate-in fade-in zoom-in-95 duration-200">
              {/* Sub Tab Toggle */}
              <div className="bg-white border border-border rounded-xl p-1 flex items-center gap-1 w-fit card-shadow">
                <button
                  onClick={() => setAttendanceSubTab("Leaves")}
                  className={`px-5 py-1.5 text-[12px] font-bold rounded-lg transition-colors ${attendanceSubTab === "Leaves" ? "bg-[#5D6BEE] text-white" : "text-slate-600 bg-white hover:bg-slate-50 border border-transparent hover:border-slate-200"}`}
                >
                  Leaves
                </button>
                <button
                  onClick={() => setAttendanceSubTab("Attendance")}
                  className={`px-5 py-1.5 text-[12px] font-bold rounded-lg transition-colors ${attendanceSubTab === "Attendance" ? "bg-[#5D6BEE] text-white" : "text-slate-600 bg-white hover:bg-slate-50 border border-transparent hover:border-slate-200"}`}
                >
                  Attendance
                </button>
              </div>
                ...
                <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
                  ...
                  <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                    <div className="p-4 border-b border-border flex items-center justify-between">
                      ...
                      <button onClick={() => setIsLeaveModalOpen(true)} className="flex items-center gap-2 px-3 py-1.5 bg-[#5D6BEE] text-white rounded-lg text-[12px] font-bold shadow-sm hover:bg-[#4b58ce] transition-colors">
                    ...
                    <div className="p-4 border-b border-border flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-50/30">
                      <div className="flex items-center gap-2 text-[12px] text-slate-600 font-medium">
                        <span>Row Per Page</span>
                        <select className="border border-border rounded px-2 py-1 outline-none bg-white font-bold"><option>10</option></select>
                        <span>Entries</span>
                      </div>
                      <input type="text" placeholder="Search" className="px-3 py-1.5 border border-border rounded-lg text-[12px] outline-none w-full sm:w-64 focus:border-[#5D6BEE]/50 transition-colors" />
                    </div>
                    ...
                    <div className="p-3 flex items-center justify-end gap-2 text-[12px] font-bold border-t border-border">
                      <button className="px-2 py-1 text-slate-500 hover:text-slate-900 transition-colors">Prev</button>
                      <button className="w-6 h-6 rounded bg-[#5D6BEE] text-white flex items-center justify-center shadow-sm">1</button>
                      <button className="px-2 py-1 text-slate-500 hover:text-slate-900 transition-colors">Next</button>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-5 animate-in slide-in-from-left-4 duration-300">
                  <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                    <div className="p-4 border-b border-border flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <h3 className="text-[14px] font-bold text-slate-900">Attendance</h3>
                      <div className="flex items-center gap-3 text-[12px] text-slate-600 font-bold">
                        <span className="flex items-center gap-2">Last Updated on : 25 May 2024 <div className="w-5 h-5 rounded-full bg-[#5D6BEE] text-white flex items-center justify-center cursor-pointer hover:bg-[#4b58ce] transition-colors"><RefreshCcw className="w-3 h-3" /></div></span>
                        <div className="px-3 py-1.5 border border-border rounded-lg flex items-center gap-2 cursor-pointer hover:bg-slate-50 transition-colors">
                          <Calendar className="w-3.5 h-3.5 text-slate-400" />
                          <span>Year : 2024 / 2025</span>
                          <ChevronDown className="w-3.5 h-3.5" />
                        </div>
                    ...
                    <div className="p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                      <AttSumCard title="Present" value="265" icon={<User className="w-4 h-4 text-[#5D6BEE]" />} iconBg="bg-[#5D6BEE]/10" />
                  ...
                  <div className="bg-white border border-border rounded-xl card-shadow overflow-hidden">
                    <div className="p-4 border-b border-border flex items-center justify-between">
                      <h3 className="text-[14px] font-bold text-slate-900">Leave & Attendance</h3>
                      <div className="flex items-center gap-3">
                        <div className="px-3 py-1.5 border border-border rounded-lg text-[12px] font-bold text-slate-700 flex items-center gap-2 cursor-pointer hover:bg-slate-50 transition-colors">
                          <Calendar className="w-3.5 h-3.5 text-slate-400" />
                          <span>This Year</span>
                          <ChevronDown className="w-3.5 h-3.5 text-slate-400" />
                        </div>
                        <div className="px-3 py-1.5 border border-border rounded-lg text-[12px] font-bold text-slate-700 flex items-center gap-2 cursor-pointer bg-slate-50 hover:bg-slate-100 transition-colors">
                        ...
                        <tbody className="divide-y divide-border text-slate-600 font-medium">
                          {[1, 2, 3, 4, 5].map(day => (
                            <tr key={day} className="hover:bg-slate-50/50 transition-colors">
                              <td className="px-4 py-3.5 font-bold text-slate-900">{day.toString().padStart(2, '0')}</td>
                              {["Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar", "Apr"].map(m => {
                                let bg = "bg-[#10B981]";
      ...
      {isLoginModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-xl shadow-xl w-[90%] max-w-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-5 border-b border-border">
              <h2 className="text-[16px] font-bold text-slate-900">Login Details</h2>
              <button onClick={() => setIsLoginModalOpen(false)} className="w-7 h-7 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:bg-slate-200 transition-colors">
                <X className="w-4 h-4" />
              </button>
            </div>
            <div className="p-6">
              <div className="flex flex-col items-center justify-center mb-6">
                ...
                <h3 className="text-[14px] font-bold text-slate-900">{student.name}</h3>
                <p className="text-[12px] font-medium text-slate-500">III, A</p>
              </div>
              <div className="border border-border rounded-xl overflow-hidden">
                <table className="w-full text-left text-[13px]">
                  <thead className="bg-[#F8FAFC] text-slate-700 font-bold border-b border-border">
                    <tr>
              ...
              <div className="mt-6 flex justify-end">
                <button onClick={() => setIsLoginModalOpen(false)} className="px-5 py-2 bg-slate-100 text-slate-700 text-[13px] font-bold rounded-lg hover:bg-slate-200 transition-colors">
                  Cancel
                </button>
              </div>
            </div>
      ...
      {isFeesModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 overflow-y-auto animate-in fade-in duration-200">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl overflow-hidden my-auto animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-5 border-b border-border">
              <div className="flex items-center gap-3">
                <h2 className="text-[16px] font-bold text-slate-900">Collect Fees</h2>
                <span className="px-2 py-0.5 bg-[#5D6BEE] text-white text-[10px] font-bold rounded">AD1 24556</span>
              </div>
              <button onClick={() => setIsFeesModalOpen(false)} className="w-7 h-7 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:bg-slate-200 transition-colors">
                <X className="w-4 h-4" />
              </button>
            </div>
            <div className="p-6">
              <div className="flex items-center justify-between bg-[#F8FAFC] rounded-xl p-4 mb-6 border border-slate-100">
                <div className="flex items-center gap-3">
                  <img src={getAvatar(student.name)} className="w-10 h-10 rounded-lg object-cover" />
                  <div>
                    <h3 className="text-[13px] font-bold text-slate-900">{student.name}</h3>
                    <p className="text-[12px] font-medium text-slate-500">III, A</p>
                  </div>
                </div>
                <div>
                  <p className="text-[11px] font-bold text-slate-900 mb-0.5">Total Outstanding</p>
                  <p className="text-[13px] font-bold text-slate-700">2000</p>
                </div>
                <div>
                  <p className="text-[11px] font-bold text-slate-900 mb-0.5">Last Date</p>
                  <p className="text-[13px] font-bold text-slate-700">25 May 2024</p>
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-slate-900">Fees Group</label>
                  <div className="relative border border-border rounded-lg overflow-hidden">
                    <select className="w-full px-3 py-2.5 text-[13px] font-medium text-slate-700 outline-none appearance-none bg-white cursor-pointer"><option>Select</option></select>
                    <ChevronDown className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                  </div>
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-slate-900">Fees Type</label>
                  <div className="relative border border-border rounded-lg overflow-hidden">
                    <select className="w-full px-3 py-2.5 text-[13px] font-medium text-slate-700 outline-none appearance-none bg-white cursor-pointer"><option>Select</option></select>
                    <ChevronDown className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                  </div>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-slate-900">Amount</label>
                  <input type="text" placeholder="Enter Amount" className="px-3 py-2.5 border border-border rounded-lg text-[13px] font-medium outline-none focus:border-[#5D6BEE]/50 transition-colors" />
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-slate-900">Collection Date</label>
                  <div className="relative border border-border rounded-lg overflow-hidden">
                    <input type="text" placeholder="Select" className="w-full px-3 py-2.5 text-[13px] font-medium outline-none bg-white" />
                    <Calendar className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                  </div>
                </div>
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-slate-900">Payment Type</label>
                  <div className="relative border border-border rounded-lg overflow-hidden">
                    <select className="w-full px-3 py-2.5 text-[13px] font-medium text-slate-700 outline-none appearance-none bg-white cursor-pointer"><option>Select</option></select>
                    <ChevronDown className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                  </div>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[12px] font-bold text-slate-900">Payment Reference No</label>
                  <input type="text" placeholder="Enter Payment Reference No" className="px-3 py-2.5 border border-border rounded-lg text-[13px] font-medium outline-none focus:border-[#5D6BEE]/50 transition-colors" />
                </div>
              </div>

              <div className="flex items-center justify-between mb-5">
                <div>
                  <p className="text-[12px] font-bold text-slate-900 mb-0.5">Status</p>
                  <p className="text-[11px] font-medium text-slate-500">Change the Status by toggle</p>
                </div>
              ...
              <div className="flex flex-col gap-1.5 mb-6">
                <label className="text-[12px] font-bold text-slate-900">Notes</label>
                <textarea rows={3} placeholder="Add Notes" className="px-3 py-2.5 border border-border rounded-lg text-[13px] font-medium outline-none focus:border-[#5D6BEE]/50 transition-colors resize-none"></textarea>
              </div>

              <div className="flex justify-end gap-3 pt-4 border-t border-border">
                <button onClick={() => setIsFeesModalOpen(false)} className="px-5 py-2 bg-slate-100 text-slate-700 text-[13px] font-bold rounded-lg hover:bg-slate-200 transition-colors">
                  Cancel
                </button>
                <button onClick={() => setIsFeesModalOpen(false)} className="px-5 py-2 bg-[#5D6BEE] text-white text-[13px] font-bold rounded-lg hover:bg-[#4b58ce] shadow-sm transition-colors">
                  Pay Fees
                </button>
              </div>
            </div>
      ...
      {isLeaveModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 overflow-y-auto animate-in fade-in duration-200">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-lg overflow-hidden my-auto animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-5 border-b border-border">
              <h2 className="text-[16px] font-bold text-slate-900">Apply Leave</h2>
              <button onClick={() => setIsLeaveModalOpen(false)} className="w-7 h-7 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 hover:bg-slate-200 transition-colors">
                <X className="w-4 h-4" />
              </button>
            </div>
            <div className="p-6 text-left">
              <div className="flex flex-col gap-1.5 mb-4">
                <label className="text-[12px] font-bold text-slate-900">Leave Date</label>
                <div className="relative border border-border rounded-lg overflow-hidden shadow-sm">
                  <input type="text" placeholder="15 May 2024" className="w-full px-3 py-2.5 text-[13px] font-medium outline-none bg-white text-slate-800" />
                  <Calendar className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                </div>
              </div>

              <div className="flex flex-col gap-1.5 mb-4">
                <label className="text-[12px] font-bold text-slate-900">Leave Type</label>
                <div className="relative border border-border rounded-lg overflow-hidden">
                  <select className="w-full px-3 py-2.5 text-[13px] font-medium text-slate-700 outline-none appearance-none bg-white cursor-pointer"><option>Select</option></select>
                  <ChevronDown className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                </div>
              ...
              <div className="flex flex-col gap-1.5 mb-4">
                <label className="text-[12px] font-bold text-slate-900">Leave From date</label>
                <div className="relative border border-border rounded-lg overflow-hidden shadow-sm">
                  <input type="text" placeholder="15 May 2024" className="w-full px-3 py-2.5 text-[13px] font-medium outline-none bg-white text-slate-800" />
                  <Calendar className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                </div>
              ...
              <div className="flex flex-col gap-1.5 mb-4">
                <label className="text-[12px] font-bold text-slate-900">Leave to Date</label>
                <div className="relative border border-border rounded-lg overflow-hidden shadow-sm">
                  <input type="text" placeholder="15 May 2024" className="w-full px-3 py-2.5 text-[13px] font-medium outline-none bg-white text-slate-800" />
                  <Calendar className="w-4 h-4 text-slate-400 absolute right-3 top-3 pointer-events-none" />
                </div>
              ...
              <div className="flex flex-col gap-2 mb-4">
                <label className="text-[12px] font-bold text-slate-900">Leave Days</label>
                <div className="flex items-center gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <div className="w-4 h-4 rounded-full border-4 border-[#5D6BEE] bg-white shadow-sm"></div>
                    <span className="text-[13px] font-medium text-slate-700">Full Day</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <div className="w-4 h-4 rounded-full border border-slate-300 bg-white"></div>
                    <span className="text-[13px] font-medium text-slate-700">First Half</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <div className="w-4 h-4 rounded-full border border-slate-300 bg-white"></div>
                    <span className="text-[13px] font-medium text-slate-700">Second Half</span>
                  </label>
                </div>
              </div>

              <div className="flex flex-col gap-1.5 mb-4">
                <label className="text-[12px] font-bold text-slate-900">No of Days</label>
                <input type="text" className="px-3 py-2.5 border border-border rounded-lg text-[13px] font-medium outline-none focus:border-[#5D6BEE]/50 transition-colors" />
              </div>

              <div className="flex flex-col gap-1.5 mb-6">
                <label className="text-[12px] font-bold text-slate-900">Reason</label>
                <textarea rows={2} className="px-3 py-2.5 border border-border rounded-lg text-[13px] font-medium outline-none focus:border-[#5D6BEE]/50 transition-colors resize-none"></textarea>
              </div>

              <div className="flex justify-end gap-3 pt-4 border-t border-border mt-2">
                <button onClick={() => setIsLeaveModalOpen(false)} className="px-5 py-2 bg-slate-100 text-slate-700 text-[13px] font-bold rounded-lg hover:bg-slate-200 transition-colors">
                  Cancel
                </button>
                <button onClick={() => setIsLeaveModalOpen(false)} className="px-5 py-2 bg-[#5D6BEE] text-white text-[13px] font-bold rounded-lg hover:bg-[#4b58ce] shadow-sm transition-colors">
                  Apply Leave
                </button>
              </div>
            </div>
...
function InfoRow({ label, value }: { label: string, value: string }) {
  return (
    <div className="flex justify-between py-1 border-b border-slate-50 last:border-0">
      <span className="text-[14px] leading-[21px] font-medium text-[#202c4b]">{label}</span>
...
function TabItem({ icon, label, active, onClick }: { icon: React.ReactNode, label: string, active: boolean, onClick: () => void }) {
  return (
    <div onClick={onClick} className={`flex flex-col items-center gap-2 px-5 py-2.5 cursor-pointer whitespace-nowrap transition-colors border-b-2 ${active ? "border-[#5D6BEE] text-[#5D6BEE]" : "border-transparent text-slate-500 hover:text-slate-700 hover:bg-slate-50"}`}>
      <div className="flex items-center gap-1.5">
        {icon}
...
function ParentRow({ name, role, phone, email, hideBorder = false }: { name: string, role: string, phone: string, email: string, hideBorder?: boolean }) {
  ...
  return (
    <div className={`flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 ${hideBorder ? '' : 'border-b border-slate-100'}`}>
      <div className="flex items-center gap-3 w-48">
        <img src={getAvatar(name)} className="w-10 h-10 rounded-lg object-cover" />
        <div>
          <p className="text-[12px] font-bold text-slate-900 mb-0.5">{name}</p>
          <p className="text-[11px] text-[#5D6BEE] font-bold">{role}</p>
        </div>
      </div>
      <div className="w-32">
        <p className="text-[11px] font-bold text-slate-900 mb-0.5">Phone</p>
        <p className="text-[12px] text-slate-500 font-medium">{phone}</p>
      </div>
      <div className="w-48">
        <p className="text-[11px] font-bold text-slate-900 mb-0.5">Email</p>
...
function DocRow({ title }: { title: string }) {
  return (
    <div className="flex items-center justify-between p-3 border border-slate-100 rounded-xl hover:border-slate-200 transition-colors bg-white">
      <div className="flex items-center gap-3">
...
function FeeRow({ group, code, due, amount, status, refId, mode, paid, discount }: any) {
  return (
    <tr className="hover:bg-slate-50/50 transition-colors">
      <td className="px-5 py-3 text-[#5D6BEE] hover:underline cursor-pointer">{group}</td>
...
function ExamCard({ title, initiallyExpanded }: { title: string, initiallyExpanded: boolean }) {
  ...
  return (
    <div className="border border-border rounded-xl overflow-hidden shadow-sm transition-all duration-200">
      <div onClick={() => setExpanded(!expanded)} className="p-4 flex items-center justify-between bg-slate-50/50 cursor-pointer hover:bg-slate-50 transition-colors">
        <div className="flex items-center gap-3">
      ...
      {expanded && (
        <div className="p-5 bg-white border-t border-border animate-in slide-in-from-top-2 duration-200">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[12px] min-w-[600px]">
              <thead className="border-b border-border text-slate-900 font-bold">
                <tr>
          ...
          <div className="mt-4 bg-[#1e293b] text-white rounded-lg p-4 flex flex-wrap items-center justify-between gap-4 text-[12px] font-bold shadow-md">
...
function LeaveCard({ title, used, available }: { title: string, used: number, available: number }) {
  return (
    <div className="bg-white border border-border rounded-xl p-4 card-shadow flex flex-col gap-2">
      <h4 className="text-[13px] font-bold text-slate-800">{title}</h4>
      <p className="text-[12px] font-bold text-slate-500 flex items-center gap-3">
        <span>Used : <span className="text-slate-700">{used}</span></span>
        <span>Available : <span className="text-slate-700">{available}</span></span>
      </p>
    </div>
  );
}
...
function LeaveRow({ type, date, days, applied, status }: { type: string, date: string, days: number, applied: string, status: "Approved" | "Pending" }) {
  return (
    <tr className="hover:bg-slate-50/50 transition-colors">
      <td className="px-5 py-3 font-bold text-slate-900">{type}</td>
...
const S_SLATE = { bg: "bg-slate-50", border: "border-slate-200", text: "text-slate-700" };
