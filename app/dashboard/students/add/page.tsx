  ...
  return (
    <div className="space-y-6 bg-[#F8FAFC] min-h-screen -m-6 p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-left">
        <div>
          <h1 className="text-xl font-bold text-slate-900">{editId ? "Edit Student" : "Add Student"}</h1>
          <div className="flex items-center gap-2 text-[13px] text-slate-500 mt-1">
            <span>Dashboard</span>
            <span>/</span>
            <Link href="/dashboard/students" className="hover:text-[#5D6BEE]">Students</Link>
            <span>/</span>
            <span className="text-slate-900 font-medium">{editId ? "Edit Student" : "Add Student"}</span>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow">
          <div className="bg-slate-50/80 px-6 py-4 border-b border-border flex items-center gap-2">
            ...
            <h2 className="text-[14px] font-bold text-slate-800">Parents & Guardian Information</h2>
          </div>
          <div className="p-6 space-y-8">
            {/* Father */}
            <div>
              <h3 className="text-[13px] font-bold text-slate-800 mb-4 border-b border-border pb-2 text-left">Father Info</h3>
              <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-shrink-0 w-32 flex flex-col items-center">
                  <div className="w-20 h-20 bg-[#F1F5F9] border-2 border-dashed border-slate-300 rounded-xl flex items-center justify-center text-slate-400 mb-3">
                    <User className="w-6 h-6 opacity-50" />
                  </div>
                  <div className="flex items-center gap-1">
                    <button type="button" className="px-3 py-1 bg-[#F1F5F9] text-slate-700 text-[11px] font-semibold rounded">Upload</button>
                    <button type="button" className="px-3 py-1 bg-[#5D6BEE] text-white text-[11px] font-semibold rounded">Browse</button>
                  </div>
                </div>
            ...
            {/* Mother */}
            <div>
              <h3 className="text-[13px] font-bold text-slate-800 mb-4 border-b border-border pb-2 text-left">Mother Info</h3>
              <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-shrink-0 w-32 flex flex-col items-center">
                  <div className="w-20 h-20 bg-[#F1F5F9] border-2 border-dashed border-slate-300 rounded-xl flex items-center justify-center text-slate-400 mb-3">
                    <User className="w-6 h-6 opacity-50" />
            ...
            {/* Guardian */}
            <div>
              <h3 className="text-[13px] font-bold text-slate-800 mb-4 border-b border-border pb-2 text-left">Guardian Details</h3>
              <div className="flex items-center gap-6 mb-5 text-left text-[13px] text-slate-700">
                <label className="font-semibold">Is Guardian?</label>
                <label className="flex items-center gap-2"><input type="radio" name="guardian" className="accent-[#5D6BEE]" defaultChecked /> Father</label>
                <label className="flex items-center gap-2"><input type="radio" name="guardian" className="accent-[#5D6BEE]" /> Mother</label>
                <label className="flex items-center gap-2"><input type="radio" name="guardian" className="accent-[#5D6BEE]" /> Other</label>
              </div>
              <div className="flex flex-col lg:flex-row gap-8">
                <div className="flex-shrink-0 w-32 flex flex-col items-center">
                  <div className="w-20 h-20 bg-[#F1F5F9] border-2 border-dashed border-slate-300 rounded-xl flex items-center justify-center text-slate-400 mb-3">
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-6 text-left">
                  ...
                  <div className="col-span-1 md:col-span-2 xl:col-span-3">
                    <label className="block text-[12px] font-semibold text-slate-700 mb-1.5">Address</label>
                    <textarea className="w-full h-10 px-3.5 py-2 text-[13px] text-slate-900 bg-white border border-border rounded-lg outline-none focus:border-[#5D6BEE]/50 transition-all"></textarea>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow">
          <div className="bg-slate-50/80 px-6 py-4 border-b border-border flex items-center gap-2 text-left">
            <Users className="w-4 h-4 text-slate-500" />
            <h2 className="text-[14px] font-bold text-slate-800">Siblings</h2>
          </div>
          <div className="p-6 text-left">
            <div className="flex items-center gap-4 mb-4 text-[13px] text-slate-700">
              <label className="font-semibold">Is Sibling studying in same school?</label>
              <label className="flex items-center gap-2"><input type="radio" name="sibling" className="accent-[#5D6BEE]" defaultChecked /> Yes</label>
              <label className="flex items-center gap-2"><input type="radio" name="sibling" className="accent-[#5D6BEE]" /> No</label>
            </div>
            ...
            <button type="button" className="px-4 py-2 bg-[#5D6BEE] text-white text-[13px] font-semibold rounded-lg hover:bg-[#4b58ce] transition-colors">
              + Add More
            </button>
          </div>
        </div>
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow">
          <div className="bg-slate-50/80 px-6 py-4 border-b border-border flex items-center gap-2 text-left">
            ...
            <h2 className="text-[14px] font-bold text-slate-800">Address</h2>
          </div>
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div>
              <label className="block text-[12px] font-semibold text-slate-700 mb-1.5">Current Address</label>
              <textarea className="w-full h-20 px-3.5 py-2 text-[13px] text-slate-900 bg-white border border-border rounded-lg outline-none focus:border-[#5D6BEE]/50 transition-all"></textarea>
            </div>
            <div>
              <label className="block text-[12px] font-semibold text-slate-700 mb-1.5">Permanent Address</label>
              <textarea className="w-full h-20 px-3.5 py-2 text-[13px] text-slate-900 bg-white border border-border rounded-lg outline-none focus:border-[#5D6BEE]/50 transition-all"></textarea>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow">
          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            <div>
              <label className="block text-[12px] font-semibold text-slate-700 mb-1.5">Medical Certificate</label>
              <p className="text-[11px] text-slate-400 mb-2">Upload document JPEG, PNG, or PDF format</p>
              <div className="flex items-center gap-3">
                <button type="button" className="px-4 py-2 bg-[#5D6BEE] text-white text-[12px] font-semibold rounded hover:bg-[#4b58ce] transition-colors">
                  Choose File
                </button>
                <span className="text-[12px] text-slate-500">No file chosen</span>
              </div>
            </div>
            <div>
              <label className="block text-[12px] font-semibold text-slate-700 mb-1.5">Migration Certificate</label>
              <p className="text-[11px] text-slate-400 mb-2">Upload document JPEG, PNG, or PDF format</p>
              <div className="flex items-center gap-3">
                <button type="button" className="px-4 py-2 bg-[#5D6BEE] text-white text-[12px] font-semibold rounded hover:bg-[#4b58ce] transition-colors">
                  Choose File
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow">
          <div className="bg-slate-50/80 px-6 py-4 border-b border-border flex items-center gap-2 text-left">
            ...
            <h2 className="text-[14px] font-bold text-slate-800">Medical History</h2>
          </div>
          <div className="p-6 space-y-5 text-left">
            <div className="flex items-center gap-4 text-[13px] text-slate-700">
              ...
              <label className="flex items-center gap-2"><input type="radio" name="medical" className="accent-[#5D6BEE]" defaultChecked /> Yes</label>
              <label className="flex items-center gap-2"><input type="radio" name="medical" className="accent-[#5D6BEE]" /> No</label>
            </div>
            <div>
              <label className="block text-[12px] font-semibold text-slate-700 mb-2">Allergies</label>
              <div className="flex gap-2">
                <span className="px-3 py-1.5 bg-[#F1F5F9] border border-border rounded-md text-[12px] font-medium text-slate-700 flex items-center gap-1.5">
                  Allergy A <XCircle className="w-3.5 h-3.5 text-slate-400 cursor-pointer" />
                </span>
                <span className="px-3 py-1.5 bg-[#F1F5F9] border border-border rounded-md text-[12px] font-medium text-slate-700 flex items-center gap-1.5">
                  Skin Allergies <XCircle className="w-3.5 h-3.5 text-slate-400 cursor-pointer" />
                </span>
              </div>
            </div>
            <div>
              <label className="block text-[12px] font-semibold text-slate-700 mb-2">Medications</label>
              <div className="flex gap-2">
                <span className="px-3 py-1.5 bg-[#F1F5F9] border border-border rounded-md text-[12px] font-medium text-slate-700 flex items-center gap-1.5">
                  Medicine Name 01 <XCircle className="w-3.5 h-3.5 text-slate-400 cursor-pointer" />
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow">
          <div className="bg-slate-50/80 px-6 py-4 border-b border-border flex items-center gap-2 text-left">
            ...
            <h2 className="text-[14px] font-bold text-slate-800">Previous School Details</h2>
          </div>
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
        ...
        <div className="bg-white border border-border rounded-xl overflow-hidden card-shadow">
          <div className="bg-slate-50/80 px-6 py-4 border-b border-border flex items-center gap-2 text-left">
            ...
            <h2 className="text-[14px] font-bold text-slate-800">Other Details</h2>
          </div>
          <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            ...
            <div className="col-span-1 md:col-span-3">
              <label className="block text-[12px] font-semibold text-slate-700 mb-1.5">Other Information</label>
              <textarea className="w-full h-20 px-3.5 py-2 text-[13px] text-slate-900 bg-white border border-border rounded-lg outline-none focus:border-[#5D6BEE]/50 transition-all"></textarea>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-4 pt-2">
          <button type="button" onClick={() => router.push("/dashboard/students")} className="px-6 py-2.5 border border-border text-[13px] font-bold rounded-lg bg-white hover:bg-slate-50 text-slate-700 transition-colors shadow-sm cursor-pointer">
            Cancel
          </button>
