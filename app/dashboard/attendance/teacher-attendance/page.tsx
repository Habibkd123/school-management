...
const mockTeachers: TeacherAttendanceItem[] = [
  { id: "T849127", name: "Janet", avatar: "https://ui-avatars.com/api/?name=Janet&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "III A", attendance: "Present", notes: "" },
  { id: "T849126", name: "Daniel", avatar: "https://ui-avatars.com/api/?name=Daniel&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "I (A)", attendance: "Present", notes: "" },
  { id: "T849125", name: "Hellana", avatar: "https://ui-avatars.com/api/?name=Hellana&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "V (A)", attendance: "Present", notes: "" },
  { id: "T849124", name: "Erickson", avatar: "https://ui-avatars.com/api/?name=Erickson&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "V (B), V (A)", attendance: "Present", notes: "" },
  { id: "T849123", name: "Morgan", avatar: "https://ui-avatars.com/api/?name=Morgan&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "VII", attendance: "Present", notes: "" },
  { id: "T849122", name: "Aaron", avatar: "https://ui-avatars.com/api/?name=Aaron&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "I (A)", attendance: "Present", notes: "" },
  { id: "T849121", name: "Jacquelin", avatar: "https://ui-avatars.com/api/?name=Jacquelin&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "V", attendance: "Present", notes: "" },
  { id: "T849120", name: "Raul", avatar: "https://ui-avatars.com/api/?name=Raul&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "X", attendance: "Present", notes: "" },
  { id: "T849119", name: "Elizabeth", avatar: "https://ui-avatars.com/api/?name=Elizabeth&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "VI", attendance: "Present", notes: "" },
  { id: "T849118", name: "Edward", avatar: "https://ui-avatars.com/api/?name=Edward&background=F1F5F9&color=5D6BEE&bold=true", teacherClass: "X (C), X (C)", attendance: "Present", notes: "" },
];

export default function TeacherAttendancePage() {
  const [attendanceData, setAttendanceData] = useState<TeacherAttendanceItem[]>(mockTeachers);
  ...
  const handleAttendanceChange = (id: string, value: TeacherAttendanceItem["attendance"]) => {
    setAttendanceData(prev => prev.map(teacher => teacher.id === id ? { ...teacher, attendance: value } : teacher));
  };

  const handleNotesChange = (id: string, value: string) => {
    setAttendanceData(prev => prev.map(teacher => teacher.id === id ? { ...teacher, notes: value } : teacher));
  };

  const filteredData = attendanceData.filter(t => {
    const matchesSearch = t.id.toLowerCase().includes(searchTerm.toLowerCase()) || 
                          t.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          t.teacherClass.toLowerCase().includes(searchTerm.toLowerCase());
                ...
                <>
                  ...
                  <div className="absolute right-0 sm:left-0 sm:right-auto top-full mt-2 w-80 bg-white dark:bg-slate-900 border border-border rounded-lg shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] z-50 text-left">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="T849127">T849127</option>
                          </select>
                    ...
                    <div className="p-4 flex justify-end gap-3 bg-white dark:bg-slate-900 rounded-b-lg border-t border-border mt-2">
                      <button 
                        onClick={() => { 
                          setFilterId(""); setFilterName(""); setFilterClass("");
                        }}
            ...
            <tbody className="divide-y divide-border">
              {filteredData.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="font-semibold text-[#F59E0B] cursor-pointer hover:text-[#D97706]">
                      {item.id}
                    </span>
                  </td>
                  <td className="px-6 py-4">
