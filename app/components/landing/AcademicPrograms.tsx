...
export function AcademicPrograms() {
  const programs = [
    ...
    { title: "Middle School", age: "Classes VI - VIII", desc: "Advanced concepts, critical thinking, and structured project work.", img: "https://images.unsplash.com/photo-1588075592446-265fd1e6e76f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8TWlkZGxlJTIwU2Nob29sfGVufDB8fDB8fHww" },
