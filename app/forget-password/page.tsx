...
import { Mail, ChevronRight, CheckCircle2, AlertCircle, Loader2, ArrowLeft } from "lucide-react";
          ...
          <div className="w-full max-w-full sm:w-[420px] bg-white dark:bg-slate-900 border border-border/60 dark:border-slate-800 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8">
            ...
            {success ? (
              ...
              <div className="text-center">
                ...
                <h1 className="text-[22px] font-bold text-[#202c4b] dark:text-slate-100 mb-2">Check your email</h1>
              ...
              <>
                <div className="mb-6">
                  <h1 className="text-[22px] font-bold text-[#202c4b] dark:text-slate-100 mb-1">Forgot Password?</h1>
